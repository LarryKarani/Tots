...
const ProblemSolved = () => {
    ...
    const cleanUpContentData = useCallback((rawData) => {
        ...
        const cleanData = rawData.map((dataObj) => {
            ...
            const { marketProblemSolved } = fields

            const image = fields.marketProblemSolvedImage.fields.file.url

            return { id, marketProblemSolved, image }
        ...
        const getData = async () => {
            try {
                const response = await client.getEntries({
                    content_type: 'marketProblemSolved',
                });
        ...
        <div className="relative py-16 bg-black pt-28" id='mission'>
            ...
            <div className="max-w-7xl mx-auto bg-indigo-600 lg:bg-transparent lg:px-8">
                <div className="lg:grid lg:grid-cols-12">
                    ...
                    <div className="relative bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
