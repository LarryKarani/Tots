            ...
            <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                <div className="space-y-12">
                    <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                        ...
                        <p className="text-4xl text-white font-extra-bold text-center">
                            TOTS Team
                        </p>
                    </div>
                    <ul
                    ...
                    >
                        {data?.map((person) => (
                            <li key={person?.fields?.title}>
                                <div className="space-y-4">
                                    <div className="aspect-w-3 aspect-h-3 ">
                                        <img className="object-cover shadow-lg rounded-lg h-50 w-50 " src={person?.fields?.file.url} alt="" />
                                    </div>

                                    <div className="space-y-2">
                                        <div className="text-lg leading-6 font-medium space-y-1">
                                            <h3 className='text-white font-bold '>{person?.fields?.title}</h3>
                                        </div>
